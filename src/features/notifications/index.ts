/**
 * Public entry point for the "notifications" feature module.
 *
 ...
 * as it is built, so other modules never reach into notifications/components or
 * notifications/* internals directly.
 */
export {};
