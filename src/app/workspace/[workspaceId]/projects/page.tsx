export default async function WorkspaceWorkspaceIdProjectsPage(props: { params: Promise<{ workspaceId: string }> }) {
  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-16">
      ...
      <p className="mt-2 text-sm text-muted-foreground">
        Placeholder for the list of projects within a workspace.
      </p>
