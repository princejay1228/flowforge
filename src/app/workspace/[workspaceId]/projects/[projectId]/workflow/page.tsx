export default async function WorkspaceWorkspaceIdProjectsProjectIdWorkflowPage(props: { params: Promise<{ workspaceId: string; projectId: string }> }) {
  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-16">
      ...
      <p className="mt-2 text-sm text-muted-foreground">
        Placeholder for the workflow editor/view: tasks, dependencies, milestones.
      </p>
