export default async function WorkspaceWorkspaceIdProjectsProjectIdVisualizationPage(props: { params: Promise<{ workspaceId: string; projectId: string }> }) {
  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-16">
      ...
      <p className="mt-2 text-sm text-muted-foreground">
        Placeholder for interactive workflow graph and other visualization modes.
      </p>
