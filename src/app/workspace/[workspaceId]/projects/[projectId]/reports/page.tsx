export default async function WorkspaceWorkspaceIdProjectsProjectIdReportsPage(props: { params: Promise<{ workspaceId: string; projectId: string }> }) {
  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-16">
      ...
      <p className="mt-2 text-sm text-muted-foreground">
        Placeholder for generated reports and PDF export.
      </p>
